...
using TechZone.Common.Exceptions;
    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                IEnumerable<ApplicationUserViewModel> modelVm = _mappingService.Mapper.Map<IEnumerable<ApplicationUser>, IEnumerable<ApplicationUserViewModel>>(model);
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, string id)
        {
            ...
            {
                var applicationUserViewModel = _mappingService.Mapper.Map<ApplicationUser, ApplicationUserViewModel>(user.Result);
                var listGroup = _appGroupService.GetListGroupByUserId(applicationUserViewModel.Id);
                applicationUserViewModel.Groups = _mappingService.Mapper.Map<IEnumerable<ApplicationGroup>, IEnumerable<ApplicationGroupViewModel>>(listGroup);
